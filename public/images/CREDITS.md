...
[Unsplash License](https://unsplash.com/license), which allows free commercial
use without attribution. They are credited here anyway, and stored in the repo
(rather than hotlinked) so the homepage renders with no third-party requests.
